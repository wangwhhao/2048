/**
 * Created by wanghao on 2016/10/29.
 */
var board = new Array();
var score = 0;
...
function prepareForMobile(){
    ...
    $(".grid-cell").css("border-radius",0.02*cellSlidLength);
}
...
function updateBoardView(){
    ...
    $(".number-cell").css("font-size",0.35*cellSlidLength+"px");
}
...
document.addEventListener("touchend",function(event){
    ...
    if(Math.abs(delatx)<0.2*documentWidth && Math.abs(deltay)<0.2*documentWidth){
        return;
    }
